...
class MonarchLinear(StructuredLinear):
    ...
    def __init__(self, *args, nblocks=4, **kwargs):
        ...
        # print("init Monarch Layer")
        # print("in feature is ", self.in_features)
        # print("out_feature is ", self.out_features)
        # print("nblocks ",  nblocks)
        in_blksz = int(math.ceil(self.in_features / nblocks))
        out_blksz = int(math.ceil(self.out_features / nblocks))
        # print("in_blksz is ", in_blksz)
        # print("out_blksz is ", out_blksz)
        ...
        # print(self.blkdiag1.shape)
        # print(self.blkdiag2.shape)
